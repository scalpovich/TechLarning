Agent Portal Sanity PageLoad Validations

Narrative:
In order to work on Agent Portal
As an Agent User
I want to validate all the Agent Portal Pages Loaded based on roles Admin, Agency, Agent, Branch
...
Scenario: Agent Portal - Services - Device Sale/Issuance - Device Sale Page
...
Scenario: Agent Portal - Services - Device Sale/Issuance - Application Correction Page
...
Scenario: Agent Portal - Services - Device Sale/Issuance - Checker Page
...
Scenario: Agent Portal - Services - Device Sale/Issuance - De-dupe Re-Verification & Approval Page
...
Scenario: Agent Portal - Services - Device Sale/Issuance - KYC Update Page
...
Scenario: Agent Portal - Services - Device Sale/Issuance - Instant Device Replacement Page
...
Scenario: Agent Portal - Services - Travel Card Currency Management - Currency Setup Page
...
Scenario: Agent Portal - Services - Travel Card Currency Management - Change Currency Priority Page
...
Scenario: Agent Portal - Services - Travel Card Currency Management - Activate/ De-activate Sub account Page
...
Scenario: Agent Portal - Services - Limited Validity Virtual Card Cancellation Page
