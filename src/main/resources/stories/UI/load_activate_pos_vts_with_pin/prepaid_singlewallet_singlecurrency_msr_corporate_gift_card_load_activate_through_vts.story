...
Meta:
@StoryName SWSC_MSR_CGC_LOAD_ACTV_VTS_PIN
@CRCardsWithAuthorization

Scenario: Set up prepaid swsc msr corporate gift card
Meta:
@TestId 
...
Scenario: prepaid swsc msr corporate gift card device production
Meta:
@TestId 
Given user is logged in institution
