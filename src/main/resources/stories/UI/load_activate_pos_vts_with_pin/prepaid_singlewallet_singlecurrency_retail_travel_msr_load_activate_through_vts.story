...
Meta:
@StoryName SWSC_MSR_RTC_LOAD_ACTV_VTS_PIN
@CRCardsWithAuthorization

Scenario: Set up prepaid swsc msr retail travel card
Meta:
@TestId 
...
Scenario: prepaid swsc msr retail travel prepaid card device production
Meta:
@TestId 
Given user is logged in institution
