...
Meta:
@StoryName SWSC_EMV_CTC_LOAD_ACTV_VTS_PIN
@CRCardsWithAuthorization

Scenario: Set up prepaid swsc emv corporate travel card
Meta:
@TestId 
...
Scenario: prepaid swsc emv corporate travel card device production
Meta:
@TestId 
Given user is logged in institution
