...
Meta:
@StoryName MWMC_MSR_CTC_LOAD_ACTV_VTS_PIN
@CRCardsWithAuthorization

Scenario: Set up prepaid mwmc msr corporate travel card
Meta:
@TestId 
...
Scenario: prepaid mwmc msr corporate travel card device production
Meta:
@TestId 
Given user is logged in institution
