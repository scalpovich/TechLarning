...
Meta:
@StoryName SWSC_EMV_RTC_LOAD_ACTV_VTS_PIN
@CRCardsWithAuthorization

Scenario: Set up prepaid swsc emv retail travel card
Meta:
@TestId 
...
Scenario: prepaid swsc emv retail travel prepaid card device production
Meta:
@TestId 
Given user is logged in institution
