...
Meta:
@StoryName MWMC_EMV_RTC_LOAD_ACTV_VTS_PIN
@CRCardsWithAuthorization

Scenario: Set up prepaid mwmc emv retail travel card
Meta:
@TestId 
...
Scenario: prepaid mwmc emv retail travel card device production
Meta:
@TestId 
Given user is logged in institution
