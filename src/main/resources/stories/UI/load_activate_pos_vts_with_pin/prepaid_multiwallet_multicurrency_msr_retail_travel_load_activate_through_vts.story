...
Meta:
@StoryName MWMC_MSR_RTC_LOAD_ACTV_VTS_PIN
@CRCardsWithAuthorization

Scenario: Set up prepaid mwmc retail travel msr card
Meta:
@TestId 
...
Scenario: prepaid mwmc retail travel msr card device production
Meta:
@TestId 
Given user is logged in institution
