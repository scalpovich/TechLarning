...
Meta:
@StoryName SWSC_EMV_CGP_LOAD_ACTV_VTS_PIN
@CRCardsWithAuthorization

Scenario: Set up prepaid swsc emv corporate general purpose card
Meta:
@TestId 
...
Scenario: prepaid swsc emv corporate general purpose card device production
Meta:
@TestId 
Given user is logged in institution
