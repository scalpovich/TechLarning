...
Meta:
@StoryName MWMC_EMV_CTC_LOAD_ACTV_VTS_PIN
@CRCardsWithAuthorization

Scenario: Set up prepaid mwmc emv corporate travel card
Meta:
@TestId 
...
Scenario: mwmc emv corporate travel card device production
Meta:
@TestId 
Given user is logged in institution
