...
Scenario: Set up prepaid msr retail general purpose pin card and perform Account Funding transaction
...
Scenario: Perform Account Funding Authorization transaction
When connection to VISA is established
When perform an POS-Retail-AccountFund_with_Pin VISA transaction
When VISA test results are verified for POS-Retail-AccountFund_with_Pin
