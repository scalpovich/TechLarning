...
In order to create EMV prepaid card
...
And prepaid device is created using new device screen for Individual [0] and Supplementary Device [S] and Existing Program [E] and EMV Card [2]
