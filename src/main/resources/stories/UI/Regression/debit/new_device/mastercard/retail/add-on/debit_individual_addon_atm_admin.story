...
And for ATM Admin Card [9] User fills Supplementary Device Plan for debit product for MASTERCARD [02]
...
Then debit device is created using new device screen for Individual [0] and Add-on Device [A] and Existing Client [E] and ATM Admin Card [9]
