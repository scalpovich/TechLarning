...
Then debit device is created using new device screen for Individual [0] and Add-on Device [A] and New Client [N] and Physical NFC Device - Mag Stripe Paypass [3]
