...
Scenario: To verify functionality of debit supplementary Physical NFC Device - Paypass [5] card boarding
...
And for Physical NFC Device - Paypass [5] User fills Supplementary Device Plan for debit product for MASTERCARD [02]
...
And debit device is created using new device screen for Individual [0] and Supplementary Device [S] and Existing Program [E] and Physical NFC Device - Paypass [5]
