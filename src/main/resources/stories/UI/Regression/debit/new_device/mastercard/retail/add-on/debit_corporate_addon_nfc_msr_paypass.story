...
Then debit device is created using new device screen for Corporate [1] and Add-on Device [A] and Existing Client [E] and Physical NFC Device - Mag Stripe Paypass [3]
