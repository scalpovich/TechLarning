...
Scenario: To verify functionality of debit supplementary Magnetic Stripe Card [1] card boarding
...
And for EMV Card [2] User fills Device Plan for debit product for MASTERCARD [02]
And for Magnetic Stripe Card [1] User fills Supplementary Device Plan for debit product for MASTERCARD [02]
...
And debit device is created using new device screen for Individual [0] and Primary Device [P] and New Client [N] and EMV Card [2]
And debit device is created using new device screen for Individual [0] and Supplementary Device [S] and Existing Program [E] and Magnetic Stripe Card [1]
