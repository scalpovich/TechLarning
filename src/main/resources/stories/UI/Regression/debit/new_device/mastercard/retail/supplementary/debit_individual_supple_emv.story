...
Scenario: To verify functionality of debit supplementary EMV Card [2] card boarding
...
And debit device is created using new device screen for Individual [0] and Supplementary Device [S] and Existing Program [E] and EMV Card [2]
