...
Then debit device is created using new device screen for Individual [0] and Primary Device [P] and New Client [N] and EMV Card [2]
Then debit device is created using new device screen for Individual [0] and Add-on Device [A] and Existing Client [E] and Magnetic Stripe Card [1]
