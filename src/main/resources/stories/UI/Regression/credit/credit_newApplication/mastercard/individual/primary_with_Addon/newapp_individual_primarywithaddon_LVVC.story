...
And for Limited Validity Virtual Card User fills Supplementary Device Plan for credit product for MASTERCARD [02]
...
When credit device is created using new Application screen for Individual [0] and "Primary and Add-on Device [B]" and New Client [N] and Limited Validity Virtual Card
And user verifies the credit application device
And user approves the credit application device
And user processes close batch for new Application
And user processes deviceGeneration batch for new Application
