...
And for Magnetic Stripe Card User fills Supplementary Device Plan for prepaid product for MASTERCARD [02]
...
When credit device is created using new Application screen for Bank Staff [2] and "Add-on Device [A]" and New Client [N] and Magnetic Stripe Card User
And user verifies the credit application device
And user approves the credit application device
And user processes close batch for new Application
And user processes deviceGeneration batch for new Application
