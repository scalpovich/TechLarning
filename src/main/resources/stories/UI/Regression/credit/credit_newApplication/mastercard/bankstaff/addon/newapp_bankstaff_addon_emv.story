...
And for Static Virtual Card User fills Device Plan for credit product for MASTERCARD [02]
...
And credit device is created using new Application screen for Bank Staff [2] and "Primary Device [P]" and New Client [N] and Static Virtual Card
...
When credit device is created using new Application screen for Bank Staff [2] and "Add-on Device [A]" and New Client [N] and EMV Card [2]
And user verifies the credit application device
And user approves the credit application device
And user processes close batch for new Application
And user processes deviceGeneration batch for new Application
