...
And for EMV Card [2] User fills Device Plan for credit product for MASTERCARD [02]
...
And credit device is created using new Application screen for Bank Staff [2] and Primary Device [P] and New Client [N] and EMV Card [2]
...
Given credit device is created using new Application screen for Bank Staff [2] and Add-on Device [A] and New Client [N] and EMV Card [2]
