...
And for NFC Device - EMV Paypass User fills Device Plan for credit product for Mastercard
And for NFC Device - Mag Stripe Paypass User fills Supplementary Device Plan for credit product for Mastercard
...
And credit device is created using new Application screen for Individual and "Primary Device" and New Client and NFC Device - EMV Paypass
...
When credit device is created using new Application screen for Bank Staff [2] and "Supplementary Device [S]" and Existing Program [E] and NFC Device - Mag Stripe Paypass
And user verifies the credit application device
And user approves the credit application device
And user processes close batch for new Application
And user processes deviceGeneration batch for new Application
