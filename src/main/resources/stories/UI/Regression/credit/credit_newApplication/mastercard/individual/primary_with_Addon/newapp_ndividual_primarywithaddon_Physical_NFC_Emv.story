...
And for NFC Device - EMV Paypass User fills Supplementary Device Plan for credit product for MASTERCARD [02]
...
And credit device is created using new Application screen for Individual and "Primary and Add-on Device [B]" and New Client and EMV Card [2]
...
When credit device is created using new Application screen for Individual [0] and "Primary and Add-on Device [B]" and New Client [N] and NFC Device - EMV Paypass
And user verifies the credit application device
And user approves the credit application device
And user processes close batch for new Application
And user processes deviceGeneration batch for new Application
