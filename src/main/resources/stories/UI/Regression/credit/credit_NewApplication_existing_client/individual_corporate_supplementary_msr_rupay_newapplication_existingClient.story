...
Meta:
@CreditRegression
@StoryName CorpSuppleMsrRupNewAppExeClient					 
Scenario: Uuser creates a Credit Device Using New Application screen with Existing client of msr type for rupay
Meta:
