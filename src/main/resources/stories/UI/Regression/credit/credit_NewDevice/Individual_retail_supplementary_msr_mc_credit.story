...
And User fills Program Retail Credit Card section for credit product for Mastercard
...
Then credit device is created using new device screen for Individual and Supplementary Device and Existing Client and Magnetic Stripe Card
