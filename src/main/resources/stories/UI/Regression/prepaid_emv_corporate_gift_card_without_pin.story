...
Scenario: Transaction - EMV_PREAUTH  and EMV_COMPLETION Authorization transaction - prepaid emv corporate gift card without PIN
...
Scenario: Perform EMV_PURCHASE Authorization transaction - prepaid emv corporate gift card without PIN
...
Scenario: Perform EMV_PURCHASE_WITH_CASHBACK Authorization transaction - prepaid emv corporate gift card without PIN
...
Scenario: Perform EMV_CASH_ADVANCE Authorization transaction - prepaid emv corporate gift card without PIN
...
Scenario: Perform EMV_CASH_WITHDRAWAL Authorization transaction - prepaid emv corporate gift card without PIN
...
Scenario: Generate Auth File for Clearing - prepaid emv corporate gift card without PIN
When Auth file is generated after transaction
When MAS simulator is closed
And user sign out from customer portal

Scenario: Clearing: Load auth file in MCPS and create NOT file of IPM extension - prepaid emv corporate gift card without PIN
...
Scenario: Upload ipm file from customer portal and process it - prepaid emv corporate gift card without PIN
Given user is logged in institution
When User uploads the NOT file
When user processes batch for prepaid
Then in batch trace history transaction is successful

Scenario: Matching & Posting to Cardholders account - prepaid emv corporate gift card without PIN
When in batch trace history transaction is successful
When transaction status is "Matching Pending"
When "Matching" batch for prepaid is successful
Then transaction status is "Presentment Matched with authorization"

Scenario: Program Balance Summary, Auth and Clearing reports download - prepaid emv corporate gift card without PIN
