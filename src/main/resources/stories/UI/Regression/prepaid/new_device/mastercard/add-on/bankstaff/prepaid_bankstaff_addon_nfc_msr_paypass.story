...
Then prepaid device is created using new device screen for Bank Staff [2] and Add-on Device [A] and New Client [N] and Physical NFC Device - Mag Stripe Paypass [3]
