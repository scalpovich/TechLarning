...
And User fills Wallet Plan for debit product and program Retail General Purpose Card [4]
...
Then prepaid device is created using new device screen for Bank Staff [2] and Add-on Device [A] and New Client [N] and Static Virtual Card [7]
