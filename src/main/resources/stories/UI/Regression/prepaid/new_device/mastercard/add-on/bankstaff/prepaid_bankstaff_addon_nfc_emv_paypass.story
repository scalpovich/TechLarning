...
And for NFC Device - EMV Paypass [4] User fills Supplementary Device Plan for prepaid product for MASTERCARD [02]
...
And prepaid device is created using new device screen for Bank Staff [2] and Add-on Device [A] and New Client [N] and NFC Device - EMV Paypass [4]
