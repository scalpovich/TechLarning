...
And for EMV Card [2] User fills Device Plan for prepaid product for MASTERCARD [02]
And for Magnetic Stripe Card [1] User fills Supplementary Device Plan for prepaid product for MASTERCARD [02]
...
Then prepaid device is created using new device screen for Bank Staff [2] and Primary Device [P] and New Client [N] and Magnetic Stripe Card [1]
Then prepaid device is created using new device screen for Bank Staff [2] and Add-on Device [A] and New Client [N] and ATM Admin Card [9]
