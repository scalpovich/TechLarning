...
Scenario: To verify functionality of NFC_EMV prepaid card boarding
...
And for Physical NFC Device - EMV Paypass [4] User fills Supplementary Device Plan for prepaid product for MASTERCARD [02]
...
And User fills Business Mandatory Fields Screen for prepaid product with All
And for Primary Device and New Client user fills Device Range section for prepaid product
And for Supplementary Device and Existing Client user fills Device Range section for prepaid product
...
And prepaid device is created using new device screen for Individual [0] and Supplementary Device [S] and Existing Program [E] and Physical NFC Device - EMV Paypass [4]
