...
And User fills Wallet Plan for prepaid product and program Corporate Travel Card - Multi Currency [6]
...
Then prepaid device is created using new device screen for Corporate [1] and Add-on Device [A] and New Client [N] and ATM Admin Card [9]
