...
Scenario: To verify functionality of addon emv prepaid card boarding
...
And prepaid device is created using new device screen for Bank Staff [2] and Add-on Device [A] and New Client [N] and EMV Card [2]
