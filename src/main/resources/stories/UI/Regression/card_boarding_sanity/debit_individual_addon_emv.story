...
Then User search for new device on search screen for debit and validates the status as NORMAL
And debit device is created using new device screen for Individual [0] and Add-on Device [A] and New Client [N] and EMV Card [2]
And debit processes pre-production batch using new Device
And debit processes deviceproduction batch using new Device for Supplementary
And User search for new device on search screen for debit and validates the status as NORMAL
