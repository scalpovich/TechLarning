...
And user edits All field of 3D Ecom Security for product debit and interchange MasterCard as uncheck
...
When user edits Decline Merchant Risk Based Decisioning Transaction field of 3D Ecom Security for product debit and interchange MasterCard as check
Then user sign out from customer portal

Scenario:1.3 Perform EMV_PURCHASE Authorization transaction
Given connection to MAS is established
And User sets Decline Merchant Risk Based Decisioning Transaction flag true
...
Given user is logged in institution
When user edits Decline Merchant Risk Based Decisioning Transaction field of 3D Ecom Security for product debit and interchange MasterCard as uncheck
Then user sign out from customer portal