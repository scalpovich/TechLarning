...
Scenario:1.2 creation of mastercard_individual_primary_emv Card credit device
Meta:
...
Scenario:1.3 creation of mastercard_individual_primary_emv Card credit device step 2
Given user is logged in institution
