...
Scenario: Transaction - EMV_PURCHASE_PIN Authorization transaction - prepaid emv corporate gift card
...
Scenario: Transaction - EMV_PURCHASE_WITH_CASHBACK_PIN Authorization transaction - prepaid emv corporate gift card
Given connection to MAS is established
