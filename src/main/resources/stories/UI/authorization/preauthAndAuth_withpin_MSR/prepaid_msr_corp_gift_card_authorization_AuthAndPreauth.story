...
Scenario: prepaid msr corporate gift card > Device production - prepaid msr gift card > Pin Generation >  Perform MSR_PREAUTH and MSR_AUTH Authorization transaction > Program Balance Summary download
