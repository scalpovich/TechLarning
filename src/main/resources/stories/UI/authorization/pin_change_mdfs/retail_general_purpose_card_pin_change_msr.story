...
As an issuer
I want to authorize Pin Change transactions for prepaid msr retail general purpose card

Meta:
@StoryName p_msr_retail_gen_purpose
@msrpinchange

Scenario: Set up prepaid msr retail general purpose card and perform Pin Change operation
