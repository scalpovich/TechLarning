...
As an issuer
I want to authorize Pin Change transactions for prepaid msr retail travel card 

Meta:
@StoryName p_msr_retail_travel
@msrpinchange

Scenario: Set up prepaid msr retail travel card and perform Pin Change operation
Meta:
@TestId TC398484
