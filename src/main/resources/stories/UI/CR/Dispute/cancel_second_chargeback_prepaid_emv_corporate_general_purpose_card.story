...
I want to handle the dispute for the transactions made my cardholder and cancel second chargeback
...
Scenario:Process cancel first chargeback request
When Charge back is created for a transaction without fees
When cancel second chargeback request