...
I want to handle the dispute for the transactions made my cardholder and process second chargeback reversal
...
Scenario: Process second chargeback rerversal 
Given user is logged in institution
When Charge back is created for a transaction without fees
When second charge back reversal is created for a transaction