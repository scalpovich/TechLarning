...
In order to assert Converstion Rate for Intra Client - Wallet to Wallet Transfer(Debit)
...
Then check Converstion Rate charge for Intra Client - Wallet to Wallet Transfer(Debit) transaction
