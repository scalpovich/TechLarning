...
In order to assert Transaction Amount for Intra Client - Wallet to Wallet Transfer(Debit)
...
Then check Transaction Amount charge for Intra Client - Wallet to Wallet Transfer(Debit) transaction
