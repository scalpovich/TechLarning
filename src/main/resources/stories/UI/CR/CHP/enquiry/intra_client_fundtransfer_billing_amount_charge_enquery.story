...
In order to assert Billing Amount for Intra Client - Wallet to Wallet Transfer(Debit)
...
Then check Billing Amount charge for Intra Client - Wallet to Wallet Transfer(Debit) transaction
