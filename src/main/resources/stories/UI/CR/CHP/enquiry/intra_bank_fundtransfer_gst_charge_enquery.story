...
In order to assert Total GST for Intra Client - Wallet to Wallet Transfer(Debit)
...
Then check Total GST charge for Intra Client - Wallet to Wallet Transfer(Debit) transaction
