...
Scenario:1 - Verify that the Users must be able to create bulk device production request from the system successfully for MC Retail MSR
Meta:
@CR
@all
...
Scenario:2 - Verify that the Users must be able to create bulk device production request from the system successfully for MC Retail MSR
Meta:
@BulkDeviceGenerationPrepaidRetailMCMSR
@TCName TC264306_Embossing File Generation
@sheetName S205014
...
Scenario:3 - Verify that the Users must be able to create bulk device production request from the system successfully for MC Corporate MSR
Meta:
@CR
@all
@BulkDeviceGenerationPrepaidCorporateMCMSR
@TCName TC264306_Embossing File Generation
@sheetName S205014
Given login to portal as existing bank as a Customeruser
...
Scenario:4 - Verify that the Users must be able to create bulk device production request from the system successfully for MC Corporate MSR
Meta:
@BulkDeviceGenerationPrepaidCorporateMCMSR
@TCName TC264306_Embossing File Generation
@sheetName S205014
