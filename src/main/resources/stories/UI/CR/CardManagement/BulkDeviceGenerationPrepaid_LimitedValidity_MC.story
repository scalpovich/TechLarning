...
Scenario: Scenario1 - Verify that the Users must be able to create bulk device production request from the system successfully for Mastercard Corp LimitedValidityVirtual
Meta:
@CR
@all
...
Scenario: Scenario3 - Verify that the Users must be able to create bulk device production request from the system successfully for Mastercard Retail StaticVirtual
Meta:
@CR
@all
...
Scenario: Scenario4 - Verify that the Users must be able to create bulk device production request from the system successfully for Mastercard Retail StaticVirtual
Meta:
Lifecycle:
After:
Outcome: SUCCESS
