...
So that Prepaid customer can get onboarded Retail Travel card - Single Wallet Single currency and use device for transaction

Scenario: Verify system allows onboarding for new prepaid customer Retail Travel card - Single Wallet Single currency using application upload funcationality
Meta:
@CR
@Scenario1_Retail_TravelCard_SingleWallet_SingleCurrency
...
When user creates Application Upload Prepaid batch file and uploads it on server for Individual for prepaid
