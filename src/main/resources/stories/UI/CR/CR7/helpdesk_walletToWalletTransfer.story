...
Scenario: To Verify functionality of wallet to wallet transfer from mastercard interchange by emv card with program Corporate Travel Card - Multi Currency
...
!-- Scenario: To Verify functionality of wallet to wallet transfer from mastercard interchange by emv card with program Retail Travel Card - Multi Currency
!-- Given user is logged in institution
!-- When User fills Statement Message Plan for prepaid product
!-- When User fills Marketing Message Plan for prepaid product
!-- When User fills Prepaid Statement Plan
...
!-- When wallet to wallet transfer selected account
!-- 
!-- Scenario: To Verify functionality of wallet to wallet transfer from mastercard interchange by emv card with program Corporate General Purpose Card
!-- Given user is logged in institution
!-- When User fills Statement Message Plan for prepaid product
!-- When User fills Marketing Message Plan for prepaid product
!-- When User fills Prepaid Statement Plan
...
!-- When User fills Device Event Based Fee Plan for prepaid product
!-- When User fills Device Plan for "prepaid" "emv" card with no pin
!-- When User fills Wallet Plan for prepaid product and program Corporate General Purpose Card [8]
...
!-- When wallet to wallet transfer selected account
!-- 
!-- Scenario: To Verify functionality of wallet to wallet transfer from mastercard interchange by emv card with program Retail General Purpose Card
!-- Given user is logged in institution
!-- When User fills Statement Message Plan for prepaid product
!-- When User fills Marketing Message Plan for prepaid product
!-- When User fills Prepaid Statement Plan
...
!-- When User fills Device Event Based Fee Plan for prepaid product
!-- When User fills Device Plan for "prepaid" "emv" card with no pin
!-- When User fills Wallet Plan for prepaid product and program Retail General Purpose Card [4]
