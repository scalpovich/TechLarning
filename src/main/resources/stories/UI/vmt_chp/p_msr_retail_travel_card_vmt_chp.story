...
Meta:
@StoryName p_visa_msr_retail_travel

Scenario: 01. Set up prepaid msr retail travel card from another institute
...
Scenario: 02. Set up prepaid msr retail travel card
