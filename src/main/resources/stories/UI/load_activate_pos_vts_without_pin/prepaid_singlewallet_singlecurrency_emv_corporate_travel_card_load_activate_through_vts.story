...
Meta:
@StoryName SWSC_EMV_CTC_LOAD_ACTV_VTS_NPIN
@CRCardsWithAuthorization

Scenario: Set up prepaid swsc emv corporate travel pinless card
Meta:
@TestId 
...
Scenario: prepaid swsc emv corporate travel pinless card device production
Meta:
@TestId 
Given user is logged in institution
