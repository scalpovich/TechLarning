...
Meta:
@StoryName SWSC_EMV_RGC_LOAD_ACTV_VTS_NPIN
@CRCardsWithAuthorization

Scenario: Set up prepaid swsc emv retail gift pinless card
Meta:
@TestId 
...
Scenario: prepaid swsc emv retail gift pinless card device production
Meta:
@TestId 
Given user is logged in institution
