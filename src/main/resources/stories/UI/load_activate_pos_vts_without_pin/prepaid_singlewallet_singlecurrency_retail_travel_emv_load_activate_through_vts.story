...
Meta:
@StoryName SWSC_EMV_RTC_LOAD_ACTV_VTS_NPIN
@CRCardsWithAuthorization

Scenario: Set up prepaid swsc emv retail travel pinless card
Meta:
@TestId 
...
Scenario: prepaid swsc emv retail travel prepaid pinless card device production
Meta:
@TestId 
Given user is logged in institution
