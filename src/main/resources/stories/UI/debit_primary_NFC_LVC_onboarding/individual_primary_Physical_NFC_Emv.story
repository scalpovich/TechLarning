Narrative:
In order to a create a debit primary Physical NFC EMV Device under customer portal cardmanagement tab
As a user
...
@Individual				 
Scenario:creation of mastercard_individual_primary_Physical NFC Device - EMV Paypass Card debit device
Meta:
...
And for NFC Device - EMV Paypass [4] User fills Device Plan for debit product for MASTERCARD [02]
...
Then debit device is created using new device screen for Individual [0] and Primary Device [P] and New Client [N] and NFC Device - EMV Paypass [4]
