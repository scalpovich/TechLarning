Narrative:
In order to a create a Debit Physical NFC Device under customer portal cardmanagement tab
As a user
...
And for NFC Device - Paypass [5] User fills Device Plan for debit product for MASTERCARD [02]
...
Then debit device is created using new device screen for Individual [0] and Primary Device [P] and New Client [N] and NFC Device - Paypass [5]
