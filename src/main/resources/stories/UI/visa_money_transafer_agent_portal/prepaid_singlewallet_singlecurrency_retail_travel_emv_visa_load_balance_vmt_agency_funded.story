Prepiad: Funded Agent : prepaid singlewallet singlecurrency retail travel emv visa load balance and vmt on agency funded
...
Meta:
@StoryName SWSC_EMV_V_RTLTRVL_AGNC_FUND
@CR1
@CardCreation

Scenario: Prepaid - prepaid singlewallet singlecurrency retail travel emv visa load balance and vmt on agency funded
