Prepiad: Non Funded Agency : prepaid multiwallet singlecurrency retail generalpurpose msr visa load balance and vmt on agency nonfunded
...
Meta:
@StoryName MWSC_MSR_V_RTLGP_AGNC_NONFUND
@CR1
@CardCreation

Scenario: prepaid multiwallet singlecurrency retail generalpurpose msr visa load balance and vmt on agency nonfunded
