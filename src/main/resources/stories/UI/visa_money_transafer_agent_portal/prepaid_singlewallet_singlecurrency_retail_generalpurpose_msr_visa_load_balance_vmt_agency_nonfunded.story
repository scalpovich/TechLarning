Prepiad: Non Funded Agency : prepaid singlewallet singlecurrency retail generalpurpose msr visa load balance and vmt on agency nonfunded
...
Meta:
@StoryName SWSC_MSR_V_RTLGP_AGNC_NONFUND
@CR1
@CardCreation

Scenario: prepaid singlewallet singlecurrency retail generalpurpose msr visa load balance and vmt on agency nonfunded 
