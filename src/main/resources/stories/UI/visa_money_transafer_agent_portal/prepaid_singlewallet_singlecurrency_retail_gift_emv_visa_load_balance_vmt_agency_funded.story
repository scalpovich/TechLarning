Prepiad: Funded Agent : prepaid singlewallet singlecurrency retail gift emv visa load balance and vmt on agency funded
...
Meta:
@StoryName SWSC_EMV_V_RTLGFT_AGNC_FUND
@CR1
@CardCreation

Scenario: prepaid singlewallet singlecurrency retail gift emv visa load balance and vmt on agency funded
