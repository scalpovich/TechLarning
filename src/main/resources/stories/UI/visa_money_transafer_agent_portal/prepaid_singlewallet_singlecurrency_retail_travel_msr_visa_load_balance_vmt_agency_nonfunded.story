Prepiad: Non Funded Agency : prepaid singlewallet singlecurrency retail travel msr visa load balance and vmt on agency nonfunded
...
Meta:
@StoryName SWSC_MSR_V_RTLTRVL_AGNC_NONFUND
@CR1
@CardCreation

Scenario: prepaid singlewallet singlecurrency retail travel msr visa load balance and vmt on agency nonfunded
