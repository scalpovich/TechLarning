Prepiad: Funded Agent : prepaid singlewallet singlecurrency retail gift msr visa load balance and vmt on agency funded
...
Meta:
@StoryName SWSC_MSR_V_RTLGFT_AGNC_FUND
@CR1
@CardCreation

Scenario: prepaid singlewallet singlecurrency retail gift msr visa load balance and vmt on agency funded
