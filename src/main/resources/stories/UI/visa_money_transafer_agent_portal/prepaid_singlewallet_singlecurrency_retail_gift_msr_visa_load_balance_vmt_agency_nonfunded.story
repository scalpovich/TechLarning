Prepiad: Non Funded Agency : prepaid singlewallet singlecurrency retail gift msr visa load balance and vmt on agency nonfunded

Narrative:
In order to do prepaid load
As an Agent User
I want to do Initial Load - Load - Reload through agent portal visa interface and transfer

Meta:
@StoryName SWSC_MSR_V_RTLGFT_AGNC_NONFUND
@CR1
@CardCreation

Scenario: prepaid singlewallet singlecurrency retail gift msr visa load balance and vmt on agency nonfunded
