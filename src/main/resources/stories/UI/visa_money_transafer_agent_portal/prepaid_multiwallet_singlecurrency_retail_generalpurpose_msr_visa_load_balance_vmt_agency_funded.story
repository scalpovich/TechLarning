Prepiad: Funded Agent : prepaid multiwallet singlecurrency retail generalpurpose msr visa load balance and  vmt on agency funded
...
Meta:
@StoryName MWSC_MSR_V_RTLGP_AGNC_FUND
@CR1
@CardCreation
Scenario: prepaid multiwallet singlecurrency retail generalpurpose msr visa load balance and  vmt on agency funded
