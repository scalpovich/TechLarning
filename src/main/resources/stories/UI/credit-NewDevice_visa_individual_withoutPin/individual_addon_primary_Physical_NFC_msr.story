...
Scenario:creation of visa_individual_primary_addon_Physical NFC Device - MSR Paypass credit device
Meta:
...
And for Physical NFC Device - Mag Stripe Paypass User fills without pin Device Plan for credit product for Visa
