...
Scenario:creation of visa_individual_primary_addon_Static Virtual Card credit device
Meta:
...
Then credit device is created using new device screen for Individual and Add-on Device and New Client and Static Virtual Card
