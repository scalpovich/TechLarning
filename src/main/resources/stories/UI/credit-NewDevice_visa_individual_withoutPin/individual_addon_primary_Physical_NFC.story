...
Scenario:creation of visa_individual_primary_addon_Physical NFC Device Paypass credit device
Meta:
...
And for Physical NFC Device - Paypass User fills without pin Device Plan for credit product for Visa
...
Then credit device is created using new device screen for Individual and Primary Device and New Client and Physical NFC Device - Paypass
