...
Scenario:creation of visa_individual_primary_addon_emv credit device
Meta:
...
Then credit device is created using new device screen for Individual and Add-on Device and New Client and EMV Card
