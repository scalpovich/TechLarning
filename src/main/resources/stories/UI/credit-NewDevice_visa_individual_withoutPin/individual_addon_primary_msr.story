...
Scenario:creation of visa_individual_primary_addon_msr credit device
Meta:
...
Then credit device is created using new device screen for Individual and Add-on Device and New Client and Magnetic Stripe Card
