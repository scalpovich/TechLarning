...
Scenario:creation of mastercard_corporate_primary_Physical NFC Device - Paypass credit device
Meta:
...
And for NFC Device - Paypass User fills without pin Device Plan for credit product for Mastercard
...
Then credit device is created using new device screen for Corporate and Primary Device and New Client and Physical NFC Device - Paypass
