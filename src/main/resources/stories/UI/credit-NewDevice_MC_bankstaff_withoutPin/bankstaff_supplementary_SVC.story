...
Scenario:creation of mastercard_bankstaff_supplementary_Static Virtual Card credit device
Meta:
...
And for Static Virtual Card User fills without pin Supplementary Device Plan for credit product for Mastercard
...
Then credit device is created using new device screen for Individual and Supplementary Device and Existing and Static Virtual Card
