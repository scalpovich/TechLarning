...
Scenario:creation of mastercard_bankstaff_supplementary_Physical NFC Device - Paypass credit device
Meta:
...
And for NFC Device - Paypass User fills without pin Supplementary Device Plan for credit product for Mastercard
...
Then credit device is created using new device screen for Individual and Supplementary Device and Existing and Physical NFC Device - Paypass
