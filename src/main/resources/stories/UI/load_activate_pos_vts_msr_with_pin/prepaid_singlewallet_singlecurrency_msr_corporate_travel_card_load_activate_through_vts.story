...
Meta:
@StoryName SWSC_MSR_CTC_LOAD_ACTV_VTS_PIN
@CRCardsWithAuthorization

Scenario: Set up prepaid swsc msr corporate travel card
Meta:
@TestId 
...
Scenario: prepaid swsc msr corporate travel card device production
Meta:
@TestId 
Given user is logged in institution
