...
Meta:
@StoryName SWSC_MSR_CGP_LOAD_ACTV_VTS_PIN
@CRCardsWithAuthorization

Scenario: Set up prepaid msr corporate gneral purpose card
Meta:
@TestId 
...
Scenario: prepaid msr corporate gneral purpose card device production
Meta:
@TestId 
Given user is logged in institution
