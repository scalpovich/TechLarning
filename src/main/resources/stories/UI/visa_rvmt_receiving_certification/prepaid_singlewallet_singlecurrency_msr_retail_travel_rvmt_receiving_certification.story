Prepaid swsc msr retail travel pinless card : Visa RVMT Receiving Certification
...
Meta:
@StoryName SWSC_MSR_RTC_LOAD_ACTV_VTS_NPIN
@visa_rvmt_receiving

Scenario: Set up prepaid swsc msr retail travel pinless card and perform Visa RVMT Receiving Certification
Meta:
@TestId
