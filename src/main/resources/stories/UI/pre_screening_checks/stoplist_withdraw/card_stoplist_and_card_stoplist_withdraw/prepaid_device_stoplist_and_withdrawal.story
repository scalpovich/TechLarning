...
Scenario:3 To  Verify that the user can stoplist prepaid device from stoplist screen
Given user is logged in institution
...
Scenario:4 Transaction - MSR_PREAUTH Authorization transaction on prepaid device after stoplisted device
...
Scenario:5 To Verify that the user can withdraw stoplist prepaid device from stoplist screen
Given user is logged in institution
When user withdraws a card from withdraw device screen
Then device has "normal" status
Then user sign out from customer portal

Scenario:6 Transaction - MSR_PREAUTH Authorization transaction on prepaid device after withdrawn device
