...
Scenario:3 To Verify that the user can stoplist debit device from stoplist screen
Given user is logged in institution
...
Scenario:4 Transaction - EMV_PREAUTH Authorization transaction on debit device after stoplisted device
...
Scenario:5 To Verify that the user can withdraw stoplist debit device from stoplist screen
Given user is logged in institution
When user withdraws a card from withdraw device screen
Then device has "normal" status
And user sign out from customer portal

Scenario:6 Transaction - EMV_PREAUTH Authorization transaction on debit device after withdrawn device
