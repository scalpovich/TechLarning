...
Scenario:1.2 To  Verify that the user can stoplist prepaid device from stoplist screen
...
Scenario:1.5 To Verify that the user can withdraw stoplist prepaid device from stoplist screen
Given user is logged in institution
