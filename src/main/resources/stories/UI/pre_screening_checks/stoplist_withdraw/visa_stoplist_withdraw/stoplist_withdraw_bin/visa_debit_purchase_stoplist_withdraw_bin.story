...
Scenario:1.2 To Verify that the user can stoplist device bin of debit device
...
Scenario:1.5 To Verify that the user can withdraw stoplist device bin of debit device
Given user is logged in institution
