...
Scenario:1.2 To Verify that the user can stoplist device range of prepaid device
...
Scenario:1.5 To Verify that the user can withdraw stoplist device range of prepaid device
Given user is logged in institution
