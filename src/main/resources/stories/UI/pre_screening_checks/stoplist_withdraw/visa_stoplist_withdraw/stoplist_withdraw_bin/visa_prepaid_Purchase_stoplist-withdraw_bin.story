...
Scenario:1.2 To Verify that the user can stoplist device bin of prepaid device
...
Scenario:1.4 Transaction - Purchase Completion transaction after bin stoplist
...
Scenario:1.5 To Verify that the user can withdraw stoplist device bin of prepaid device
Given user is logged in institution
When user withdraws a device Bin from withdraw device Bin screen
Then user sign out from customer portal

Scenario:1.6 Transaction - Purchase Completion transaction after bin withdrawn
Given connection to VISA is established
When perform an POS-Retail-Magstripe-purchase_with_Pin VISA transaction
