...
Scenario:1.2 To Verify that the user can stoplist device range of credit device
...
Scenario:1.5 To Verify that the user can withdraw stoplist device range of credit device
Given user is logged in institution
