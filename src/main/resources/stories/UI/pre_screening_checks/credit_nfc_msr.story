...
Scenario:creation of mastercard_individual_primary_nfc_msr Card credit device
...
And for NFC Device - Mag Stripe User fills Device Plan for credit product for Mastercard
...
Scenario:creation of mastercard_individual_primary_nfc_msr Card credit device step 2
Given user is logged in institution
