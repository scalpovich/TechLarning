...
@FileUpload
Scenario: creation of visa_Individual_primary_NFC_msr credit device using applicationUpload functionality
...
And User Primary Device fills New Program Retail Credit Card section without dedupe for credit product for Visa
