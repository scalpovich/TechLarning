...
@FileUpload
Scenario: creation of visa_Corporate_primary_nfc credit device using applicationUpload functionality
...
And for NFC Device - Paypass User fills without pin Device Plan for credit product for Visa
