...
@FileUpload
Scenario: creation of visa_Corporate_primary_LVVC credit device using applicationUpload functionality
...
And for Limited Validity Virtual Card User fills without pin Device Plan for credit product for Visa
