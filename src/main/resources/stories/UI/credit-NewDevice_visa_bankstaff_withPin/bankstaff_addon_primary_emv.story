...
Scenario:creation of visa_bankstaff_addon_primary_emv credit device
Meta:
...
Then credit device is created using new device screen for Bank Staff and Add-on Device and New Client and EMV Card
