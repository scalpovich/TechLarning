...
I want to create Limited Validity Virtual prepaid cards as per FEMA configuration
So that  I can use use these cards for transactions


Meta:
@R7Regression
@FemaPrepaidLimitedValidity
...
Meta:
@CorporateTravelSingleCurrencyLimitedValidity
...
Then user should be able to create Limited Validity Virtual Card for Prepaid product for Corporate customer
...
Meta:
@CorporateTravelMultiCurrencyLimitedValidity
@TCName TC264321_Embossing File Generation
@sheetName S205014
@Stage
Given login to portal as existing bank as a Customeruser
...
Meta:
@RetailTravelSingleCurrencyLimitedValidity
@TCName TC264321_Embossing File Generation
@sheetName S205014
@Stage
Given login to portal as existing bank as a Customeruser
...
Then user should be able to create Limited Validity Virtual Card for Prepaid product for Individual customer

Scenario: Scenario4 - Verify that the Issuer is able to create Retail Travel Card for Multi Wallet Multi Currency Type  
Meta:
@RetailTravelMultiCurrencyLimitedValidity
@TCName TC264321_Embossing File Generation
@sheetName S205014
@Stage
Given login to portal as existing bank as a Customeruser
