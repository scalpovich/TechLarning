...
I want to create Static Virtual prepaid cards as per FEMA configuration
So that  I can use use these cards for transactions


Meta:
@R7Regression
@FemaPrepaidStaticVirtual
...
Then user should be able to create Static Virtual Card for Prepaid product for Corporate customer
...
Meta:
@Regression
@CorporateTravelMultiCurrencyStaticVirtual
@TCName TC264321_Embossing File Generation
@sheetName S205014
@Stage
Given login to portal as existing bank as a Customeruser
