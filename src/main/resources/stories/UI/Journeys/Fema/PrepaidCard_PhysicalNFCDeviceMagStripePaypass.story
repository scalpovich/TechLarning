...
I want to create Physical NFC Device Mag Stripe Paypass prepaid cards as per FEMA configuration
So that  I can use use these cards for transactions


Meta:
@R7Regression
@FemaPrepaidNFCMagnetic
...
Meta:
@CorporateTravelSingleCurrencyPhysicalNFC
...
Then user should be able to create Physical NFC Device - Mag Stripe Paypass for Prepaid product for Corporate customer
...
Meta:
@CorporateTravelMultiCurrencyPhysicalNFC
@TCName TC264318_Embossing File Generation
@sheetName S205014
@Stage
Given login to portal as existing bank as a Customeruser
...
Meta:
@RetailTravelSingleCurrencyPhysicalNFC
@TCName TC264318_Embossing File Generation
@sheetName S205014
@Stage
Given login to portal as existing bank as a Customeruser
...
Then user should be able to create Physical NFC Device - Mag Stripe Paypass for Prepaid product for Individual customer

Scenario: Scenario4 - Verify that the Issuer is able to create Retail Travel Card for Multi Wallet Multi Currency Type  
Meta:
@RetailTravelMultiCurrencyPhysicalNFC
@TCName TC264318_Embossing File Generation
@sheetName S205014
Given login to portal as existing bank as a Customeruser
...
Then user should be able to create Physical NFC Device - Mag Stripe Paypass for Prepaid product for Indivdual customer
When user defines the service code as Currency Setup and creates 2 wallets for prepaid card
Then the prepaid card should be a multiwallet card