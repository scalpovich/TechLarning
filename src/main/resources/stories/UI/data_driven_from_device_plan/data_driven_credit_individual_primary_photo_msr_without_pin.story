...
Scenario: 1.6 To verify photo files are generated in JPEG format when Get Photo Card batch is successfully executed on saved path in batch definition for the batch
Meta: 
@TC857975
Given setting json values in excel for Credit
Given user is logged in institution
...
Scenario: 1.7 To verify that status(Successful/Failed/In Progress) of scheduled Get Photo Card batch is displayed on batch job history page when searched with either job id or batch name along with schedule date
Meta: 
@TC857976
Given setting json values in excel for Credit
Given user is logged in institution
