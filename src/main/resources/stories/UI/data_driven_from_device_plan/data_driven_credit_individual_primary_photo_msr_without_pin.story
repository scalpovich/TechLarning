...
Scenario: To verify that Super Admin user is able to provide access for new download batch ?Get Photo Card?  to operations user
Meta:
@TC857970
Given user is logged in institution
Then client photo/flat file download batch is present under download in batch level priviledge page
...
Scenario:To verify the screen details when ?Get Photo Card? batch is selected on Process batches screen
Meta:
@TC857972
Given setting json values in excel for Credit
Given user is logged in institution
...
Scenario:To verify photo files are generated in JPEG format when Get Photo Card batch is successfully executed on saved path in batch definition for the batch
Meta: 
@TC857975
Given setting json values in excel for Credit
Given user is logged in institution
...
And check status in batch job history for DOWNLOAD batch and CLIENT_PHOTO_DOWNLOAD
