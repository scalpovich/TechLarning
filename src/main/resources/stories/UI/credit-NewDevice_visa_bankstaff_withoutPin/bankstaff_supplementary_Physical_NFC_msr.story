...
Scenario:creation of visa_bankstaff_supplementary_Physical NFC Device - Mag Stripe Paypass Card credit device
Meta:
...
And for NFC Device - Mag Stripe Paypass User fills without pin Supplementary Device Plan for credit product for Visa
...
Then credit device is created using new device screen for Individual and Supplementary Device and Existing and Physical NFC Device - Mag Stripe Paypass
