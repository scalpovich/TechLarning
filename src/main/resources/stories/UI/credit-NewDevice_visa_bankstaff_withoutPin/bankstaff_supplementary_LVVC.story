...
Scenario:creation of visa_bankstaff_supplementary_LVVC Card credit device
Meta:
...
And for Magnetic Stripe Card User fills without pin Device Plan for credit product for Visa
And for Limited Validity Virtual Card User fills without pin Supplementary Device Plan for credit product for Visa
...
Then credit device is created using new device screen for Individual and Supplementary Device and Existing and Limited Validity Virtual Card
