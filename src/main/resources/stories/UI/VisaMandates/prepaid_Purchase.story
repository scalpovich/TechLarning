...
As an issuer
I want to perform Purchase through vts

Meta:
@StoryName VISAPREPAID
@visa_transaction_types

Scenario: 01. Set up prepaid msr retail general purpose pin card and perform Purcahse transaction
...
Scenario: 04. Transaction - Purchase Completion transaction
