...
As an issuer
I want to perform Refund through vts

Meta:
@StoryName VISAPREPAID
@visa_transaction_types

Scenario: 01. Set up prepaid msr retail general purpose pin card and perform Refund transaction
...
Scenario: 04. Transaction - Refund transaction
