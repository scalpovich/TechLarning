...
As an issuer
I want to perform Eligibility_Inquiry through vts

Meta:
@StoryName VISAPREPAID
@visa_transaction_types

Scenario: 01. Set up prepaid msr retail general purpose pin card and perform Eligibility_Inquiry transaction
...
Scenario: 04. Transaction - Eligibility_Inquiry transaction
