...
As an issuer
I want to perform STIP Advice through vts

Meta:
@StoryName VISAPREPAID
@visa_transaction_types

Scenario: 01. Set up prepaid msr retail general purpose pin card and perform STIP Advice transaction
...
Scenario: 04. Transaction - STIP Advice transaction
