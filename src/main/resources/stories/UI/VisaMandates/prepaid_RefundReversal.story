...
As an issuer
I want to perform Refund Reversal through vts

Meta:
@StoryName VISAPREPAID
@visa_transaction_types

Scenario: 01. Set up prepaid msr retail general purpose pin card and perform Refund Reversal transaction
...
Scenario: 04. Transaction - Refund Reversal transaction
