...
As an issuer
I want to perform Cash Withdrawal through vts

Meta:
@StoryName VISAPREPAID
@visa_transaction_types

Scenario: 01. Set up prepaid msr retail general purpose pin card and perform Cash Withdrawl transaction
...
Scenario: 04. Transaction - Cash eWithdrawl
