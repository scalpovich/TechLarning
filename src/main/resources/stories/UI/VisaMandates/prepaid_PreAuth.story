...
As an issuer
I want to perform Pre-Auth through vts

Meta:
@StoryName VISAPREPAID
@visa_transaction_types

Scenario: 01. Set up prepaid msr retail general purpose pin card and perform PreAuth transaction
...
Scenario: 04. Transaction - PreAuth transaction
