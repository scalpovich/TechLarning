...
As an issuer
I want to perform ReturnofGoods through vts

Meta:
@StoryName VISAPREPAID
@visa_transaction_types

Scenario: 01. Set up prepaid msr retail general purpose pin card and perform ReturnofGoods transaction
...
Scenario: 04. Transaction - Return of Goods transaction
