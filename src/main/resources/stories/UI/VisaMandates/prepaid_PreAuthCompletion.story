...
Scenario: 01. Set up prepaid msr retail general purpose pin card and perform PreAuth Completion transaction
...
Scenario: 04. Transaction - PreAuth Completion transaction
