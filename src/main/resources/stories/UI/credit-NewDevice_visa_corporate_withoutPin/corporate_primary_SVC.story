...
Scenario:creation of visa_corporate_primary_StaticVirtualCard credit device
Meta:
...
Then credit device is created using new device screen for Corporate and Primary Device and New Client and Static Virtual Card
