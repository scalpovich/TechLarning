...
Scenario:creation of visa_corporate_primary_Physical NFC Device - EMV Paypass Card credit device
Meta:
...
And for NFC Device - EMV Paypass User fills without pin Device Plan for credit product for Visa
...
Then credit device is created using new device screen for Corporate and Primary Device and New Client and Physical NFC Device - EMV Paypass
