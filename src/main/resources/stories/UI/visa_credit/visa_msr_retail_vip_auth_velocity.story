...
I want to validate manual auth for vip client on magstripe retail card
So that auth is successfully completed with fees assertion even if exceeding mcg limit daily velocity

Meta:
@StoryName cr_visa_msr_manual_auth
@visa_msr_retail_vip_auth_velocity
@ttt
...
When user is logged in institution
And user updates client details
