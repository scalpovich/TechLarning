...
@Individual				 
Scenario:creation of mastercard_individual_primary_Physical NFC Device - EMV Paypass Card prepaid device
Meta:
...
And for NFC Device - EMV Paypass [4] User fills Device Plan for prepaid product for MASTERCARD [02]
...
Then prepaid device is created using new device screen for Individual [0] and Primary Device [P] and New Client [N] and NFC Device - EMV Paypass [4]
