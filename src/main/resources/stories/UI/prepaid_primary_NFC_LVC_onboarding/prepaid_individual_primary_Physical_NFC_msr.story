Narrative:
In order to a create a Prepaid Primary Physical NFC MSR Device under customer portal cardmanagement tab
As a user
...
@Individual				 
Scenario:creation of mastercard_individual_primary_Physical NFC Device - msr Paypass Card prepaid device
Meta:
...
And for NFC Device - Mag Stripe Paypass [3] User fills Device Plan for prepaid product for MASTERCARD [02]
...
Then prepaid device is created using new device screen for Individual [0] and Primary Device [P] and New Client [N] and NFC Device - Mag Stripe Paypass [3]
