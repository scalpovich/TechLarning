...
Scenario: 3.2 Create MID_TID Blocking Rule
Given user is logged in institution
When user creates MID TID Blocking for combination 5
Then user sign out from customer portal

Scenario: 3.3 Perform EMV_PURCHASE Authorization transaction
...
Scenario: 3.4 Verify Decline Code on Helpdesk Page
Given user is logged in institution
When verify Decline code for Transaction MID-TID Blocked on helpdesk page for product Credit
Then user sign out from customer portal

Scenario: 3.5 Delete Fifth Combination of MID_TID Blocking rule
Given user is logged in institution
When user deletes MID TID Blocking for Combination 5
Then user sign out from customer portal

Scenario: 3.6 Perform EMV_PURCHASE Authorization transaction
Given perform an EMV_PURCHASE MAS transaction on the same card
When MAS test results are verified
And user is logged in institution
Then search Purchase authorization and verify 000-Successful status
...
Scenario: 3.7 Create MID_TID Blocking Rule
Given user is logged in institution
When user creates MID TID Blocking for combination 7
Then user sign out from customer portal

Scenario: 3.8 Perform EMV_PURCHASE Authorization transaction
...
Scenario: 3.9 Verify Decline Code on Helpdesk Page
Given user is logged in institution
When verify Decline code for Transaction MID-TID Blocked on helpdesk page for product Credit
Then user sign out from customer portal

Scenario: 4.0 Delete Seventh Combination of MID_TID Blocking rule
Given user is logged in institution
When user deletes MID TID Blocking for Combination 7
Then user sign out from customer portal

Scenario: 4.1 Perform EMV_PURCHASE Authorization transaction
Given perform an EMV_PURCHASE MAS transaction on the same card
When MAS test results are verified
And user is logged in institution
Then search Purchase authorization and verify 000-Successful status
...
Scenario: 4.2 Create MID_TID Blocking Rule
Given user is logged in institution
When user creates MID TID Blocking for combination 8
Then user sign out from customer portal

Scenario: 4.3 Perform EMV_PURCHASE Authorization transaction
...
Scenario: 4.4 Verify Decline Code on Helpdesk Page
Given user is logged in institution
When verify Decline code for Transaction MID-TID Blocked on helpdesk page for product Credit
Then user sign out from customer portal

Scenario: 4.5 Delete Eight Combination of MID_TID Blocking rule
Given user is logged in institution
When user deletes MID TID Blocking for Combination 8
Then user sign out from customer portal

Scenario: 4.6 Perform EMV_PURCHASE Authorization transaction
Given perform an EMV_PURCHASE MAS transaction on the same card
When MAS test results are verified
And user is logged in institution
Then search Purchase authorization and verify 000-Successful status
...
Scenario: 4.7 Create MID_TID Blocking Rule
Given user is logged in institution
When user creates MID TID Blocking for combination 9
Then user sign out from customer portal

Scenario: 4.8 Perform EMV_PURCHASE Authorization transaction
...
Scenario: 4.9 Verify Decline Code on Helpdesk Page
Given user is logged in institution
When verify Decline code for Transaction MID-TID Blocked on helpdesk page for product Credit
Then user sign out from customer portal

Scenario: 5.0 Delete Ninth Combination of MID_TID Blocking rule
Given user is logged in institution
When user deletes MID TID Blocking for Combination 9
Then user sign out from customer portal

Scenario: 5.1 Perform EMV_PURCHASE Authorization transaction
Given perform an EMV_PURCHASE MAS transaction on the same card
When MAS test results are verified
And user is logged in institution
Then search Purchase authorization and verify 000-Successful status
...
Scenario: 5.2 Create MID_TID Blocking Rule
Given user is logged in institution
When user creates MID TID Blocking for combination 10
Then user sign out from customer portal

Scenario: 5.3 Perform EMV_PURCHASE Authorization transaction
...
Scenario: 5.4 Verify Decline Code on Helpdesk Page
Given user is logged in institution
When verify Decline code for Transaction MID-TID Blocked on helpdesk page for product Credit
Then user sign out from customer portal

Scenario: 5.5 Delete Tenth Combination of MID_TID Blocking rule
Given user is logged in institution
When user deletes MID TID Blocking for Combination 10
Then user sign out from customer portal

Scenario: 5.6 Perform EMV_PURCHASE Authorization transaction
Given perform an EMV_PURCHASE MAS transaction on the same card
When MAS test results are verified
And user is logged in institution
Then search Purchase authorization and verify 000-Successful status
...
Scenario: 5.7 Create MID_TID Blocking Rule
Given user is logged in institution
When user creates MID TID Blocking for combination 11
Then user sign out from customer portal

Scenario: 5.8 Perform EMV_PURCHASE Authorization transaction
...
Scenario: 5.9 Verify Decline Code on Helpdesk Page
Given user is logged in institution
When verify Decline code for Transaction MID-TID Blocked on helpdesk page for product Credit
Then user sign out from customer portal

Scenario: 6.0 Delete Eleventh Combination of MID_TID Blocking rule
Given user is logged in institution
When user deletes MID TID Blocking for Combination 11
Then user sign out from customer portal

Scenario: 6.1 Perform EMV_PURCHASE Authorization transaction
Given perform an EMV_PURCHASE MAS transaction on the same card
When MAS test results are verified
And user is logged in institution
Then search Purchase authorization and verify 000-Successful status
