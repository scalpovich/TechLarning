...
Scenario:creation of mastercard_individual_addon_primary_Physical NFC Device - msr Paypass Card credit device
Meta:
...
Then credit device is created using new device screen for Individual and Add-on Device and New Client and Physical NFC Device - Mag Stripe Paypass
