...
As a user
I want to caught duplicate application and then reject application

Meta:
@StoryName credit_emv_retail
Scenario: To verify user is not able to board a duplicate application when dedupe/SDN plan is configured.
...
Scenario: To verify user is not able to board a duplicate application when dedupe/SDN plan is configured. with duplicate application.
Given setting json values in excel for Credit
