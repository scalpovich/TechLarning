Narrative:
In order to verify cash advance transaction for mastercard retail msr credit card
As a user
...
Scenario: To verify cash advance transaction for MasterCard retail emv device
