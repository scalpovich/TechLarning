Narrative:
In order to check transactions on emv corporate credit card 
As an issuer
I want to authorize REFUND transaction for emv corporate credit card

Meta:
@StoryName TC556774

Scenario: To verify cash withdrawal transaction for MasterCard msr corporate credit device
...
When user performs an EMV_REFUND MAS transaction
