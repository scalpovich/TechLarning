...
@FileUpload
Scenario: creation of MC_Individual_primary_LVVC credit device using applicationUpload functionality
Given setting json values in excel for Credit
When user is logged in institution
And for Limited Validity Virtual Card User fills without pin Device Plan for credit product for Mastercard
