Narrative:
As a Admin User
I want to go to Agent Portal and check validation of Mobile Number and Email ID while creating Corporate users
...
Scenario: Verificaiton of MobileNumber's uniqueness for Corporate User Creation
Meta:
@Regression
...
And user enters Corporate User's existing EmailId and unique MobileNumber
...
|Pinwheel [65432117172000001]|CorpRole [Role for corporate]|UniqueUserID|AutoUserName|AutoAddress|SPAIN [724]|411006|Autotest@gmail.com|en|IND [+91]|UniqueMobile|User creation successful|



Scenario: Verificaiton of EmailID's uniqueness for Corporate User Creation
Meta:
@Regression
Given that user is on channelManagement Page
When user clicks on Corporate User Create link
...
And user provide Corporate User's ParentID,RoleID,UserID and UserName
And user enters Corporate User's Address,Country,PostalCode,PreferredLanguage and ISDCode
And user enters Corporate User's unique EmailId and existing MobileNumber
And user clicks on create button
And user should get the error Message

Examples:
|ParentID|RoleID|UserID|UserName|Address|Country|PostalCode|EmailId|PreferredLanguage|ISDCode|MobileNumber|Message|
|Pinwheel [65432117172000001]|CorpRole [Role for corporate]|UniqueUserID|AutoUserName|AutoAddress|SPAIN [724]|411006|UniqueEmail|en|IND [+91]|9000000001|Mobile number should be unique.Entered mobile number is already registered against other User.|


Scenario: Verificaiton of both EmailID and MobileNumber's uniqueness for Corporate User Creation
Meta:
@Regression
Given that user is on channelManagement Page
When user clicks on Corporate User Create link
