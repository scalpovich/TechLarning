...
Given user updates isEligibleRequest.json with below Attributes:
|AttributesToUpdate|
...
Then user updates fetchAvailableDevices_Request.json with below Attributes:
|AttributesToUpdate|
...
Then user updates sendOtp.json with below Attributes:
|AttributesToUpdate|
|otpValue=22223333|
|timeStamp=GET_TIME|
|sessionId=GET_SESSIONID|
...
Given user updates isEligibleRequest.json with <field>
