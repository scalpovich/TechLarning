...
Meta:
@TC264329
@EmbossingLimitedValidityVirtualcard
@TCName TC264329_Embossing File Generation
@sheetName S205014
...
|FILLER [FILLER]|
|CVV [[CVV]]|
And attach the template to the new device plan of Limited Validity Virtual Card
And user creates a new Debitdevice with the required configuration
