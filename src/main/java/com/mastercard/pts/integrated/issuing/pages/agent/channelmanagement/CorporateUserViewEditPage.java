...
@Navigation(tabTitle = ChannelManagementNav.TAB_CHANNEL_MANAGEMENT, treeMenuItems = { ChannelManagementNav.L1_CORPORATE,
		ChannelManagementNav.L2_CORPORATE_USER, ChannelManagementNav.L3_CORPORATE_USER_VIEW_EDIT })
public class CorporateUserViewEditPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(CorporateUserViewEditPage.class);
