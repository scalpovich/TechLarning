...
public class DeviceDeDupeSDNVerificationPage extends AbstractModelPage {

	private static final Logger logger = LoggerFactory.getLogger(DeviceDeDupeSDNVerificationPage.class);
	...
	public void verifyUiOperationStatus() {
		logger.info("Device De Dupe SDN Verification");
