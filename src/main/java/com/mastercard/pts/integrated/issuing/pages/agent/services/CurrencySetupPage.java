...
public class CurrencySetupPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(CurrencySetupPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Currency Setup Master Detail Tilte Text: {}");
