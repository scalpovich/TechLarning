...
public class StockReturnPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(StockReturnPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Stock Return Master Detail Tilte Text: {}");
