...
@Navigation(tabTitle = CardManagementNav.TAB_CARD_MANAGEMENT, treeMenuItems = {
		...
		CardManagementNav.L3_RESEND_TO_PERSONALIZATION_VENDOR })
public class ReSendToPersonalizationVendorPage extends AbstractModelPage {

	private static final Logger logger = LoggerFactory
			.getLogger(ReSendToPersonalizationVendorPage.class);
	...
	public void verifyUiOperationStatus() {
		logger.info("Re Send To Personalization Vendor");
