...
@Navigation(tabTitle = ChannelManagementNav.TAB_CHANNEL_MANAGEMENT, treeMenuItems = { ChannelManagementNav.L1_AGENT, ChannelManagementNav.L2_AGENT_USER,
		ChannelManagementNav.L3_AGENT_USER_VIEW_EDIT })
public class AgentUserViewEditPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(AgentUserViewEditPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Agent User View Edit Master Detail Tilte Text: {}");
