...
@Navigation(tabTitle = ChannelManagementNav.TAB_CHANNEL_MANAGEMENT, treeMenuItems = { ChannelManagementNav.L1_AGENCY, ChannelManagementNav.L2_AGENCY_USER,
		ChannelManagementNav.L3_AGENCY_USER_ACTIVE_DEACTIVE_USER })
public class AgencyUserActiveDeactiveUserPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(AgencyUserActiveDeactiveUserPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Agency User Active Deactive User Master Detail Tilte Text: {}");
