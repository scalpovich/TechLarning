...
@Navigation(tabTitle = CardManagementNav.TAB_CARD_MANAGEMENT, treeMenuItems = {
		...
		CardManagementNav.L3_HIGH_RISK_MERCHANT_LOCATION
		})
public class HighRiskMerchantLocationPage extends AbstractModelPage {

	private static final Logger logger = LoggerFactory
			.getLogger(HighRiskMerchantLocationPage.class);
	...
	protected Collection<ExpectedCondition<WebElement>> isLoadedConditions() {
		return Arrays.asList(
				WebElementUtils.elementToBeClickable(acquirerId),
				WebElementUtils.elementToBeClickable(merchantId),
