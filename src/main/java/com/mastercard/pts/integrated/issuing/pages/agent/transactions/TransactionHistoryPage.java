...
@Component
@Navigation(tabTitle = TransactionsNav.TAB_TRANSACTIONS, treeMenuItems = { TransactionsNav.L1_OTHERS, TransactionsNav.L2_OTHERS_TRANSACTION_HISTORY })
public class TransactionHistoryPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(TransactionHistoryPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Transaction History Master Detail Tilte Text: {}");
