...
@Navigation(tabTitle = ChannelManagementNav.TAB_CHANNEL_MANAGEMENT, treeMenuItems = { ChannelManagementNav.L1_BRANCH, ChannelManagementNav.L2_BRANCH_USER,
		ChannelManagementNav.L3_BRANCH_USER_VIEW_EDIT })
public class BranchUserViewEditPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(BranchUserViewEditPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Branch User View Edit Detail Tilte Text: {}");
