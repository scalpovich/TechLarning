...
public final class Navigator {
	...
	public void navigateToTab(String tabTitle) {
		...
		String tabLocator = String.format("//a[contains(.,'%s')]/..", tabTitle);
		MCWebElement tab = WebElementUtils.fluentWait(() -> finderProvider.get().findOne(FindBy.X_PATH, tabLocator));
		if (!WebElementUtils.hasClass(tab, "active")) {
