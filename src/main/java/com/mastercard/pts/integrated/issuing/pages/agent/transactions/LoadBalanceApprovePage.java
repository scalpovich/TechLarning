...
public class LoadBalanceApprovePage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(LoadBalanceApprovePage.class);
	...
	public void verifyUiOperationStatus() {
		logger.info("Load Balance Approve");
		verifyButton("Search");
	}
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Load Balance Approve Master Detail Tilte Text: {}");
