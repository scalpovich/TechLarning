...
public class ServicesSteps {
	...
	public void thenActivateDeactivateSubAccountPageLoaded(String expectedTitleText) {
		assertThat(FAILED_MESSAGE_INFO, servicesWorkflow.getActivateDeactivateSubAccountMasterDetailContentTitleText(),
	...
	public void thenApplicationCorrectionPageLoaded(String expectedTitleText) {
		assertThat(FAILED_MESSAGE_INFO, servicesWorkflow.getApplicationCorrectionMasterDetailContentTitleText(),
				containsString(expectedTitleText));
	}
	...
	public void thenChangeCurrencyPrioriyPageLoaded(String expectedTitleText) {
		assertThat(FAILED_MESSAGE_INFO, servicesWorkflow.getChangeCurrencyPriorityMasterDetailContentTitleText(),
				containsString(expectedTitleText));
	}
	...
	public void thenCheckerPageLoaded(String expectedTitleText) {
		assertThat(FAILED_MESSAGE_INFO, servicesWorkflow.getCheckerMasterDetailContentTitleText(),
				containsString(expectedTitleText));
	}
	...
	public void thenCurrencySetupPageLoaded(String expectedTitleText) {
		assertThat(FAILED_MESSAGE_INFO, servicesWorkflow.getCurrencySetupMasterDetailContentTitleText(),
				containsString(expectedTitleText));
	}
	...
	public void thenDedupeReverificationApprovalPageLoaded(String expectedTitleText) {
		assertThat(FAILED_MESSAGE_INFO, servicesWorkflow.getDedupeReverificationApprovalMasterDetailContentTitleText(),
				containsString(expectedTitleText));
	}
	...
	public void thenDeviceSalePageLoaded(String expectedTitleText) {
		assertThat(FAILED_MESSAGE_INFO, servicesWorkflow.getDeviceSaleMasterDetailContentTitleText(),
				containsString(expectedTitleText));
	}
	...
	public void thenInstantDeviceReplacementPageLoaded(String expectedTitleText) {
		assertThat(FAILED_MESSAGE_INFO, servicesWorkflow.getInstantDeviceReplacementMasterDetailContentTitleText(),
				containsString(expectedTitleText));
	}
	...
	public void thenKYCUpdatePageLoaded(String expectedTitleText) {
		assertThat(FAILED_MESSAGE_INFO, servicesWorkflow.getKYCUpdateMasterDetailContentTitleText(),
				containsString(expectedTitleText));
	}
	...
	public void thenLimitedValidityVirtualCardCancellationPageLoaded(String expectedTitleText) {
		assertThat(FAILED_MESSAGE_INFO,
				servicesWorkflow.getLimitedValidityVirtualCardCancellationMasterDetailContentTitleText(),
				containsString(expectedTitleText));
	}
	...
	public void thenRegistrationIsSuccessful() {
		assertThat("Registration Failed", servicesWorkflow.getApplicationCreatedMessage(),
				containsString(APPLICATION_CREATED_MESSAGE));
	}

	@Then("application creation is successful")
	public void thenApplicationCreationIsSuccessful() {
		assertThat("Application Creation Failed", servicesWorkflow.getApplicationCreatedSuccessMessage(),
				containsString(APPLICATION_CREATED_MESSAGE));
	}
	...
	public void thenCurrencySetupForTheDeviceIsSuccessful() {
		assertThat("Currency Setup Failed", servicesWorkflow.getSuccessMessage(),
				containsString(DEVICE_MULTI_CURRENCY_SETUP_MSG));
	}
}