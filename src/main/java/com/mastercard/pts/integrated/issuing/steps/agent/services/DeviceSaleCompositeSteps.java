...
public class DeviceSaleCompositeSteps {
	...
	@Composite(steps = { "Given user is logged in agent portal as admin user",
			...
			"Given user is logged in agent portal as agency user", "When user fills order details and submits the form",
			...
			"Given login to portal as existing bank as a user", "When user navigates to General in Helpdesk",
	...
	@Composite(steps = { "Given login to portal as existing bank as a user",
