...
public class DeviceSaleCompositeSteps {
	...
	@Composite(steps = { "Given user is logged in agent portal as admin user",
			...
			"Given user is logged in institution", "When user fills quantity to be dispatched and submits the form",
			"Then user logouts from customer portal", "Given user is logged in agent portal as agency user",
