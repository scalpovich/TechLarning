...
@Component
@Navigation(tabTitle = TransactionsNav.TAB_TRANSACTIONS, treeMenuItems = { TransactionsNav.L1_LOAD_BALANCE, TransactionsNav.L2_LOAD_BALANCE_REQUEST })
public class LoadBalanceRequestPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(LoadBalanceRequestPage.class);
	...
	public void verifyUiOperationStatus() {
		logger.info("Load Balance Request");
		verifyButton("Search");
	}
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Load Balance Request Master Detail Tilte Text: {}");
