...
@Navigation(tabTitle = ChannelManagementNav.TAB_CHANNEL_MANAGEMENT, treeMenuItems = { ChannelManagementNav.L1_BRANCH, ChannelManagementNav.L2_BRANCH_ENTITY,
		ChannelManagementNav.L3_BRANCH_ENTITY_CREATE_ACTIVATE_SUSPEND_AGENCY })
public class BranchEntityActivateSuspendBranchPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(BranchEntityActivateSuspendBranchPage.class);
