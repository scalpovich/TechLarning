...
@Navigation(tabTitle = AdministrationNav.TAB_ADMINISTRATION, treeMenuItems = {
		...
		AdministrationNav.L2_USER_MANAGEMENT_REPORT
		})
public class UserManagementReportPage extends AbstractModelPage{

	private static final Logger logger = LoggerFactory
			.getLogger(UserManagementReportPage.class);

	@PageElement(findBy = FindBy.NAME, valueToFind = "componentPanel")
	private MCWebElement selectReportDDwn;

	public void verifyUiOperationStatus() {
		logger.info("User Management Report");
	}
