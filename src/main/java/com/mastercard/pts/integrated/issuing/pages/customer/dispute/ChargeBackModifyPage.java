...
@Navigation(tabTitle = DisputeNav.TAB_DISPUTE, treeMenuItems = {
		...
		DisputeNav.L3_CHARGEBACK_MODIFY })
public class ChargeBackModifyPage extends AbstractDisputePage {

	private static final Logger logger = LoggerFactory
			.getLogger(ChargeBackModifyPage.class);
