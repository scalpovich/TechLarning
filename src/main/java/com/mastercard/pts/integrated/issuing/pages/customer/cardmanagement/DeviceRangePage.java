...
public class DeviceRangePage extends AbstractBasePage {
	...
	public void clickAddDeviceRange() {
		waitForElementVisible(AddDeviceRangeBtn);
	...
	public void enterFromDeviceNo() {
		...
		enterText(FromDeviceNumberTxt, String.valueOf(i) + Constants.FromDevice);

	}

	public void enterToDeviceNo() {
		addWicketAjaxListeners(getFinder().getWebDriver());
		enterText(ToDeviceNumberTxt, String.valueOf(i) + Constants.ToDevice);
