...
public class ReplaceDevicePage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(ReplaceDevicePage.class);
	...
	public void verifyUiOperationStatus() {
		logger.info("Replace Device");
		verifyTitleCardHolderPortal("Replace Device");
		verifyWalletDetails();
		verifyDeviceDetails();
		verifyButton("Submit");
		verifyButton("Cancel");
