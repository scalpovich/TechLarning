...
public class InstitutionPrerequisiteCreationSteps{
	...
	@When("user creates new business calendar with future date")
	public void givenUserCreatesNewBusinessCalendarWithFutureDate(){
		BusinessCalendar bc=BusinessCalendar.createWithProvider(dbProvider);
		institutionCreationWorkflow.createFutureBusinessCalendar(bc);
	}
