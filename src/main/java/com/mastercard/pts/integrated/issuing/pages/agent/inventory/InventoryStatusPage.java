...
public class InventoryStatusPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(InventoryStatusPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Inventory Status Master Detail Tilte Text: {}");
