...
import com.mastercard.pts.integrated.issuing.workflows.AccountMasterFlows;
 ...
 */
@Component
public class AccountMasterSteps extends AccountMasterFlows {
	...
	public void checkNonMandatoryProgramField() {
		...
		Assert.assertTrue(checkSavedAccountMaster());
	...
	public void checkingDebitProgramCodesInProgramField() {
		...
		Assert.assertTrue(verifyListOfDebitCodesInProgramCodeField());
		sessionExpiryloginInAgain();
	}
	...
	public void verifyLabelAccounthead() {
		...
		Assert.assertTrue(accountMasterPage.verifyLabelAccountHead());
		sessionExpiryloginInAgain();
	}
