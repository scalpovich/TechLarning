...
@Navigation(tabTitle = CardManagementNav.TAB_CARD_MANAGEMENT, treeMenuItems = {
		...
		CardManagementNav.L3_CARRIER_ACKNOWLEDGEMENT })
public class CarrierAcknowledgementPage extends AbstractModelPage {

	private static final Logger logger = LoggerFactory
			.getLogger(CarrierAcknowledgementPage.class);
