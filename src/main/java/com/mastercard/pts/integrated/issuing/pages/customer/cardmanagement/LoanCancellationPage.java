...
@Navigation(tabTitle = CardManagementNav.TAB_CARD_MANAGEMENT, treeMenuItems = {
		...
		CardManagementNav.L2_LOAN,
		CardManagementNav.L3_LOAN_CANCELLATION
		})

public class LoanCancellationPage extends AbstractModelPage {
	
	private static final Logger logger = LoggerFactory.getLogger(LoanCancellationPage.class);
