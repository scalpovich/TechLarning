...
@Component
@Navigation(tabTitle = ActivityNav.TAB_ACTIVITY, treeMenuItems = { ActivityNav.L1_RECEIPT_BOOK_MAINTENANCE, ActivityNav.L2_BOOK_CONFIRMATION_RETURN })
public class BookConfirmationReturnPage extends AbstractModelPage {

	private static final Logger logger = LoggerFactory.getLogger(BookConfirmationReturnPage.class);
	...
	public void verifyUiOperationStatus() {
		logger.info("Book Confirmation/Return");
		verifySearchButton("Search");
	}

	@Override
	protected Collection<ExpectedCondition<WebElement>> isLoadedConditions() {
		return Arrays.asList(WebElementUtils.elementToBeClickable(reqCodeTxt), WebElementUtils.elementToBeClickable(cityDDwn),
