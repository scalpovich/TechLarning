...
@Navigation(tabTitle = CardManagementNav.TAB_CARD_MANAGEMENT, treeMenuItems = {
		...
		CardManagementNav.L4_CARD_FEES
		})

public class CardFeesPage extends AbstractModelPage {
	
	private static final Logger logger = LoggerFactory.getLogger(CardFeesPage.class);
	...
	protected Collection<ExpectedCondition<WebElement>> isLoadedConditions() {
		return Arrays.asList(
				...
				WebElementUtils.elementToBeClickable(reason)
				);
	}
}