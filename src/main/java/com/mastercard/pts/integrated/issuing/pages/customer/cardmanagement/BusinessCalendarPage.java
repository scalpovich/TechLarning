...
public class BusinessCalendarPage extends AbstractModelPage {

	private static final Logger logger = LoggerFactory
			.getLogger(BusinessCalendarPage.class);
	...
	public void verifyUiOperationStatus() {
		...
		verifyUiOperation("Add Business Calendar");
	}

	public void addBusinessCalendar(BusinessCalendar bc) {
		logger.info("create Business calendar on effective date : {}",
				bc.getEffectiveDate());
		clickAddNewButton();
