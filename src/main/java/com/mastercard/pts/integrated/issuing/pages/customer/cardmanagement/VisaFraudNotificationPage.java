...
@Navigation(tabTitle = CardManagementNav.TAB_CARD_MANAGEMENT, treeMenuItems = {
		...
		CardManagementNav.L3_VISA_FRAUD_NOTIFICATION})

public class VisaFraudNotificationPage extends AbstractModelPage {

	private static final Logger logger = LoggerFactory
			.getLogger(VisaFraudNotificationPage.class);
	...
	public void verifyUiOperationStatus() {
		logger.info("Visa Fraud Notification");
