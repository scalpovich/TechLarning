...
@Navigation(tabTitle = ChannelManagementNav.TAB_CHANNEL_MANAGEMENT, treeMenuItems = { ChannelManagementNav.L1_AGENT, ChannelManagementNav.L2_AGENT_USER,
		ChannelManagementNav.L3_AGENT_USER_RESET_USER_PSSWD })
public class AgentUserResetUserPasswordPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(AgentUserResetUserPasswordPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Agent User Reset User Password Master Detail Tilte Text: {}");
