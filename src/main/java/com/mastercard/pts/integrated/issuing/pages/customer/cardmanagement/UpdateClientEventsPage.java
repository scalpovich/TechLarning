...
@Component
@Navigation(tabTitle = CardManagementNav.TAB_CARD_MANAGEMENT, treeMenuItems = { CardManagementNav.L1_ACTIVITY, CardManagementNav.L2_CLIENT,
		CardManagementNav.L3_UPDATE_CLIENT_EVENTS })
public class UpdateClientEventsPage extends AbstractModelPage {
	...
	public void verifyUiOperationStatus() {
		logger.info("Update Client Events");
		verifySearchButton("Search");
	}

	@Override
	protected Collection<ExpectedCondition<WebElement>> isLoadedConditions() {
		return Arrays.asList(WebElementUtils.elementToBeClickable(clientCodeTxt), WebElementUtils.elementToBeClickable(deviceNumberTxt),
				WebElementUtils.elementToBeClickable(firstNameTxt), WebElementUtils.elementToBeClickable(lastNameTxt),
				WebElementUtils.elementToBeClickable(registeredMobileNumberTxt));
	}
}
