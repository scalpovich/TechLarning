...
public class TransactionWorkflow extends SimulatorUtilities {
	...
	public String searchTransactionWithDeviceAndGetJoiningFee(Device device, TransactionSearch ts) {
		TransactionSearchPage page = navigator.navigateToPage(TransactionSearchPage.class);
		return page.searchTransactionWithDeviceAndGetJoiningFees(device, ts);
	}
