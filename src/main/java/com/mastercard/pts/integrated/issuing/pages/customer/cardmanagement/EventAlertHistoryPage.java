...
@Component
@Navigation(tabTitle = CardManagementNav.TAB_CARD_MANAGEMENT, treeMenuItems = { CardManagementNav.L1_SEARCH, CardManagementNav.L2_EVENT_ALERT_HISTORY })
public class EventAlertHistoryPage extends AbstractBasePage {
	...
	protected Collection<ExpectedCondition<WebElement>> isLoadedConditions() {
		return Arrays.asList(WebElementUtils.elementToBeClickable(jobId), WebElementUtils.elementToBeClickable(evtJobId),
				WebElementUtils.elementToBeClickable(batchJobId), WebElementUtils.elementToBeClickable(alertType),
				WebElementUtils.elementToBeClickable(eventIdDDwn), WebElementUtils.elementToBeClickable(processingMode),
				WebElementUtils.elementToBeClickable(alertStatus), WebElementUtils.elementToBeClickable(executionMode),
				WebElementUtils.elementToBeClickable(channelDDwn), WebElementUtils.elementToBeClickable(loggedFromDateDPkr),
