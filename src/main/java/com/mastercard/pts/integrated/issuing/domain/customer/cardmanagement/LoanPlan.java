...
public class LoanPlan {
	...
	private static final String NUMBER_OF_CURRNET_LOAN ="NUMBER_OF_CURRNET_LOAN";
	...
	private static final String MIN_INTREST_RATE ="MIN_INTREST_RATE";
	private static final String MAX_INTREST_RATE ="MAX_INTREST_RATE";
	private static final String MAX_MOROTORIUM_PERIOD ="MAX_MOROTORIUM_PERIOD";
	...
	public static LoanPlan dataProvider(KeyValueProvider keyValueProvider){
		...
		loanPlan.setNumberOfConcurrentLoan(keyValueProvider.getString(NUMBER_OF_CURRNET_LOAN));
		...
		loanPlan.setMinimumInterestRate(keyValueProvider.getString(MIN_INTREST_RATE));
		loanPlan.setMaximumInterestRate(keyValueProvider.getString(MAX_INTREST_RATE));
		loanPlan.setMaximumMoratoriumPeriod(keyValueProvider.getString(MAX_MOROTORIUM_PERIOD));
