...
public class InventorySteps {
	...
	public void thenCreateRolePageLoaded(String expectedTitleText){
		assertThat(FAILED_MESSAGE_INFO, inventoryWorkflow.getOrderMasterDetailContentTitleText(), containsString(expectedTitleText));
	}
	...
	public void thenAcceptancePageLoaded(String expectedTitleText){
		assertThat(FAILED_MESSAGE_INFO, inventoryWorkflow.getAcceptanceMasterDetailContentTitleText(), containsString(expectedTitleText));
	}
	...
	public void thenStatusPageLoaded(String expectedTitleText){
		assertThat(FAILED_MESSAGE_INFO, inventoryWorkflow.getStatusMasterDetailContentTitleText(), containsString(expectedTitleText));
	}
	...
	public void thenOrderCancellationPageLoaded(String expectedTitleText){
		assertThat(FAILED_MESSAGE_INFO, inventoryWorkflow.getOrderCancellationMasterDetailContentTitleText(), containsString(expectedTitleText));
	}
	...
	public void thenStockTransferIntraBranchPageLoaded(String expectedTitleText){
		assertThat(FAILED_MESSAGE_INFO, inventoryWorkflow.getStockTransferIntraBranchMasterDetailContentTitleText(), containsString(expectedTitleText));
	}
	...
	public void thenStockTransferAcceptancePageLoaded(String expectedTitleText){
		assertThat(FAILED_MESSAGE_INFO, inventoryWorkflow.getStockTransferAcceptanceMasterDetailContentTitleText(), containsString(expectedTitleText));
	}
	...
	public void thenStockReturnPageLoaded(String expectedTitleText){
		assertThat(FAILED_MESSAGE_INFO, inventoryWorkflow.getStockReturnMasterDetailContentTitleText(), containsString(expectedTitleText));
	}
	...
	public void thenInventoryStatusPageLoaded(String expectedTitleText){
		assertThat(FAILED_MESSAGE_INFO, inventoryWorkflow.getInventoryStatusMasterDetailContentTitleText(), containsString(expectedTitleText));
	}
	...
	public void thenOrderIsSuccessful(){
		assertThat("Order Creation Failed", inventoryWorkflow.getOrderCreationMessage(), containsString(ORDER_CREATION_MESSAGE));
	}
	...
	public void thenOrderAcceptanceIsSuccessful(){
		assertThat("Dispatch Acceptance Failed", inventoryWorkflow.getDispatchAcceptanceMessage(), containsString(ACCEPTANCE_MESSAGE));
	}
