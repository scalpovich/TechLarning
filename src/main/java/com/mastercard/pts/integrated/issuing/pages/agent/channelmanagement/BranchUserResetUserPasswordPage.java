...
@Navigation(tabTitle = ChannelManagementNav.TAB_CHANNEL_MANAGEMENT, treeMenuItems = { ChannelManagementNav.L1_BRANCH, ChannelManagementNav.L2_BRANCH_USER,
		ChannelManagementNav.L3_BRANCH_USER_RESET_USER_PSSWD })
public class BranchUserResetUserPasswordPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(BranchUserResetUserPasswordPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Branch User Reset User Password Master Detail Tilte Text: {}");
