...
public class AssignServiceCodePage extends AbstractModelPage {

	private static final Logger logger = LoggerFactory
			.getLogger(AssignServiceCodePage.class);

	@PageElement(findBy = FindBy.NAME, valueToFind = "searchDiv:rows:1:componentList:0:componentPanel:input:dropdowncomponent")
	private MCWebElement userNameOrGroupCodeDDwn;

	public void verifyUiOperationStatus() {
		logger.info("Assign Service Code");
		verifyUiOperation("Add User Service Code");
	}
