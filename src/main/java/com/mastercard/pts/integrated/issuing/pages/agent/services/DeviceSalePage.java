...
public class DeviceSalePage extends AbstractModelPage {
    ...
    public void clickNewCustomerWithRegistrationRadioButton(){
		...
		.until(WebElementUtils.elementToBeClickable(newCustomerWithRegistrationRbtn))
		.click();
    }
    
    public void clickNewCustomerWithOutRegistrationRadioButton(){
		new WebDriverWait(driver(), timeoutInSec)
		.until(WebElementUtils.elementToBeClickable(newCustomerWithOutRegistrationRbtn))
		.click();
    }
    
    public void clickExistingCustomerNewProgamRadioButton(){
		new WebDriverWait(driver(), timeoutInSec)
		.until(WebElementUtils.elementToBeClickable(existingCustomerNewProgramRbtn))
		.click();
    }

    public void clickExistingCustomerAdditionalDeviceSelfRadioButton(){
		new WebDriverWait(driver(), timeoutInSec)
		.until(WebElementUtils.elementToBeClickable(existingCustomerAdditionalDeviceSelfRbtn))
		.click();
    }
	
    public void clickExistingCustomerAdditionalDeviceOthersRadioButton(){
		new WebDriverWait(driver(), timeoutInSec)
		.until(WebElementUtils.elementToBeClickable(existingCustomerAdditionalDeviceOthersRbtn))
		.click();
    }
	
    public void clickExistingCustomerRegistrationRadioButton(){
		new WebDriverWait(driver(), timeoutInSec)
		.until(WebElementUtils.elementToBeClickable(existingCustomerRegistrationRbtn))
		.click();
    }
    ...
    public void clickProcessButton(){
    	new WebDriverWait(driver(), timeoutInSec)
		.until(WebElementUtils.visibilityOf(processBtn)).click();
    }
    ...
    public void clickNextButton(){
		new WebDriverWait(driver(), timeoutInSec)
		.until(WebElementUtils.elementToBeClickable(nextBtn))
		.click();
    }
    ...
    public void clickSubmitButton(){
		new WebDriverWait(driver(), timeoutInSec)
		.until(WebElementUtils.elementToBeClickable(submitBtn))
		.click();
    }
    ...
    public String getApplicationCreatedMessage(){
    	return new WebDriverWait(driver(), timeoutInSec)
		.until(WebElementUtils.visibilityOf(applicationSuccessMessage)).getText();
    }
    
    public void verifyApplicationSuccessMessage(){
    	new WebDriverWait(driver(), timeoutInSec)
		.until(WebElementUtils.visibilityOf(applicationSuccessMessage));
    }
    ...
    public void deviceSaleThroughCustomerRegistration(DeviceSale details){
    	...
    	fillApplicationDetails1(details);
        enterKycRemarks(details.getKycremarks());
        enterLegalId1(details.getLegalId());
        fillApplicationDetails2AndSubmit();
     }
	...
	public String getActiveDeviceNumberFromDb(String productType, String deviceType) {
		...
		{
			activeDeviceNumber = dbUtility.getSingleRecordColumnValueFromDB(QUERY_STRING_DEVICE_NUMBER_PREPAID_EMV, DEVICE_NUMBER_COLUMN_NAME);
		}
		else if(PREPAID.equalsIgnoreCase(productType) && MAGSTRIPE.equalsIgnoreCase(deviceType))
		{
			activeDeviceNumber = dbUtility.getSingleRecordColumnValueFromDB(QUERY_STRING_DEVICE_NUMBER_PREPAID_MAGSTRIPE, DEVICE_NUMBER_COLUMN_NAME);
		}
