...
@Component
@Navigation(tabTitle = AdministrationNav.TAB_ADMINISTARTION, treeMenuItems = { AdministrationNav.L1_AGENCY_CREATION })
public class AgencyCreationPage extends AbstractModelPage {
