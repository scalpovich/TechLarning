...
@Navigation(tabTitle = DisputeNav.TAB_DISPUTE, treeMenuItems = {
		...
		DisputeNav.L3_SECOND_CHARGEBACK_MODIFY })

public class SecondChargeBackModifyPage extends AbstractDisputePage {

	private static final Logger logger = LoggerFactory
			.getLogger(SecondChargeBackModifyPage.class);
	...
	public void verifyUiOperationStatus() {
		logger.info("Second Chargeback Modify");
