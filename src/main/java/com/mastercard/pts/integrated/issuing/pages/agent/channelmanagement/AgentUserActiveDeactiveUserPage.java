...
@Navigation(tabTitle = ChannelManagementNav.TAB_CHANNEL_MANAGEMENT, treeMenuItems = { ChannelManagementNav.L1_AGENT, ChannelManagementNav.L2_AGENT_USER,
		ChannelManagementNav.L3_AGENT_USER_ACTIVE_DEACTIVE_USER })
public class AgentUserActiveDeactiveUserPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(AgentUserActiveDeactiveUserPage.class);
	...
	public void verifyUiOperationStatus() {
		logger.info("Agent User Information");
		verifyButton("Search");
	}
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Agent User Active Deactive User Master Detail Tilte Text: {}");
