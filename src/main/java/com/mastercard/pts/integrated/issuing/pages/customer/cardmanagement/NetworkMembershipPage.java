...
public class NetworkMembershipPage extends AbstractBasePage {
	...
	public static int undoPresentmentLimit=0;
	...
	public void editNetworkMembershipPlan(DevicePlan device) {
		...
		runWithinPopup("Edit Network Membership", () -> {
			...
			if (undoPresentmentLimit == 0) {
				enterValueinTextBox(presentmentTimeLimitTxt, device.getTransSetPresentmentTimeLimit());
			}else{
				enterValueinTextBox(presentmentTimeLimitTxt, "50");
			}
			SimulatorUtilities.wait(1500);
			clickSaveButton();
