...
public class UserPage extends AbstractModelPage{
	...
	public void enterMobileNumber(UserCreation userCreation) {
		System.out.println(userCreation.getMobileNumber());
	...
	public void assignInstituteToUser(InstutionCreation instituteCreation) {
		System.out.println(instituteCreation.getInstitutionName());
		clickWhenClickable(Element(institutionAssignedToUser.replace("%s",
				instituteCreation.getInstitutionName())));
	}

	public void assignDefaultInstituteToUser(InstutionCreation instituteCreation) {
	...
	public void mapInstituteToUser(InstutionCreation instituteCreation) {
		try {
