...
public class FileCreation {
	...
	private static final String UPLOAD_FILEPATH = System
	...
	public String createCERFileMC() {
		...
		applicationUploadMap = dataReader.fnReadEntireTestData(UPLOAD_FILEPATH,
				"CERFileUploadMC", "Records");

		try (PrintWriter writer = new PrintWriter(file)) {
			// writer.println(createCERMCHeader(date, time));
			writer.println("H201505301400231");
	...
	public String createCERUploadFileBank() {
		int totalRecords = 0;
		FileCreation fileCreation = new FileCreation();
		HashMap<String, HashMap<String, String>> applicationUploadMap;
		String date = nextDay(DateUtils.getDateddMMyyyy(), "Bank")
				+ DateUtils.getTime();
		filenameStatic = "CER"
