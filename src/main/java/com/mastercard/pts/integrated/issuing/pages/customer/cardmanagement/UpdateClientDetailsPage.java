...
@Navigation(tabTitle = CardManagementNav.TAB_CARD_MANAGEMENT, treeMenuItems = { CardManagementNav.L1_ACTIVITY, CardManagementNav.L2_CLIENT,
		CardManagementNav.L3_UPDATE_CLIENT_DETAILS })
public class UpdateClientDetailsPage extends AbstractModelPage {
	...
	protected Collection<ExpectedCondition<WebElement>> isLoadedConditions() {
		return Arrays.asList(WebElementUtils.elementToBeClickable(clientCodeTxt), WebElementUtils.elementToBeClickable(cbsClientIdTxt),
