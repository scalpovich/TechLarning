...
public class CardToCashTransactionPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(CardToCashTransactionPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Card to Cash Transaction Master Detail Tilte Text: {}");
