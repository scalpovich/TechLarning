...
public class CashRemittancesPage extends AbstractModelPage {
	...
	public void verifyUiOperationStatus() {
		logger.info("Cash Remittances");
		verifyTitleCardHolderPortal("Cash Remittances");
		verifyWalletDetails();
		verifyButton("Submit");
		verifyButton("Cancel");
	}
	...
	protected Collection<ExpectedCondition<WebElement>> isLoadedConditions() {
		return Arrays.asList(WebElementUtils.visibilityOf(masterDetailContentTitle), WebElementUtils.visibilityOf(fromDateDPkr),
				WebElementUtils.visibilityOf(toDateDPkr), WebElementUtils.visibilityOf(dateRangeRbtn), WebElementUtils.visibilityOf(remittanceNumberRbtn));
	}
}
