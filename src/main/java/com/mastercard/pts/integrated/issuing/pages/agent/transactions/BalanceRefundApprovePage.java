...
@Navigation(tabTitle = TransactionsNav.TAB_TRANSACTIONS,
	treeMenuItems = { TransactionsNav.L1_BALANCE_REFUND,TransactionsNav.L2_BALANCE_REFUND_APPROVE})
public class BalanceRefundApprovePage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(BalanceRefundApprovePage.class);
    ...
    public String getMasterDetailContentTitleText(){
    	logger.info("Balance Refund Approve Master Detail Tilte Text: {}");
