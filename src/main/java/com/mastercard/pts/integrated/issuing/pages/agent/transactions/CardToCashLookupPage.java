...
public class CardToCashLookupPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(CardToCashLookupPage.class);
    ...
    public String getMasterDetailContentTitleText(){
    	logger.info("Card to Cash Lookup Master Detail Tilte Text: {}");
