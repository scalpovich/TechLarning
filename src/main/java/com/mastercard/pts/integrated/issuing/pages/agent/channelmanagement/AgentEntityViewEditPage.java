...
public class AgentEntityViewEditPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(AgentEntityViewEditPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Agent Entity View Edit Master Detail Tilte Text: {}");
