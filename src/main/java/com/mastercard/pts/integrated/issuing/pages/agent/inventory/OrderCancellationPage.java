...
public class OrderCancellationPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(OrderCancellationPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Order Cancellation Master Detail Tilte Text: {}");
