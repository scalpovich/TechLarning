...
@Navigation(tabTitle = ChannelManagementNav.TAB_CHANNEL_MANAGEMENT, treeMenuItems = { ChannelManagementNav.L1_ADMINISTRATOR,
		ChannelManagementNav.L2_ADMINISTRATOR_USER, ChannelManagementNav.L3_ADMINISTRATOR_USER_VIEW_EDIT })
public class AdministratorUserViewEditPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(AdministratorUserViewEditPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Administrator User View Edit Master Detail Tilte Text: {}");
