...
@Navigation(tabTitle = CardManagementNav.TAB_CARD_MANAGEMENT, treeMenuItems = {
		CardManagementNav.L1_ACTIVITY, CardManagementNav.L2_AUTHORIZATION,
		CardManagementNav.L3_GENERATE_REVERSAL })
public class GenerateReversalPage extends AbstractModelPage {

	private static final Logger logger = LoggerFactory
			.getLogger(GenerateReversalPage.class);
