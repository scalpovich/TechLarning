...
public class BusinessSetupHomePage extends AbstractModelPage {

	private static final Logger logger = LoggerFactory.getLogger(BusinessSetupHomePage.class);
	...
	public void verifyUiOperationStatus() {
		logger.info("Business Setup Home");
		verifyHomePageCollectPortal("Business Setup");
	}
