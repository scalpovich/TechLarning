...
@Navigation(tabTitle = ChannelManagementNav.TAB_CHANNEL_MANAGEMENT, treeMenuItems = { ChannelManagementNav.L1_AGENCY, ChannelManagementNav.L2_AGENCY_ENTITY,
		ChannelManagementNav.L3_AGENCY_ENTITY_VIEW_EDIT })
public class AgencyEntityViewEditPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(AgencyEntityViewEditPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Agency Entity View Edit Master Detail Tilte Text: {}");
