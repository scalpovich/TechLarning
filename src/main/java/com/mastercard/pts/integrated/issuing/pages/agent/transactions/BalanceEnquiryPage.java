...
public class BalanceEnquiryPage extends AbstractModelPage {
	private static final Logger logger = LoggerFactory.getLogger(BalanceEnquiryPage.class);
	...
	public String getMasterDetailContentTitleText() {
		logger.info("Balance Enquiry Master Detail Tilte Text: {}");
