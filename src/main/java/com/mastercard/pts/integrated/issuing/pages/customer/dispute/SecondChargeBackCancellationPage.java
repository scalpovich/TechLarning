...
@Navigation(tabTitle = DisputeNav.TAB_DISPUTE, treeMenuItems = {
		...
		DisputeNav.L3_SECOND_CHARGEBACK_CANCELLATION })

public class SecondChargeBackCancellationPage extends AbstractDisputePage {

	private static final Logger logger = LoggerFactory
			.getLogger(SecondChargeBackCancellationPage.class);
	...
	@PageElement(findBy = FindBy.CSS, valueToFind = "[fld_fqn=transactionDate]")
	private MCWebElement transactionDateDpkr;
	...
	public void verifyUiOperationStatus() {
		logger.info("Second Chargeback Cancellation");
